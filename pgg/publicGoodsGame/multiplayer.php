    ...
    <div id = "intro">
        <div id = "intro-popup">
            ...
            <div id = "intro-img-space">
                ...
                <img class = "intro-img" src = "../publicGoodsGame/assets/images/info2_c.png" style = "display:none;"></img>
			...
			<div id = "game-interface" style = "visibility:hidden;">
				...
				<div style = "display:none;" id = "rp">
					<div id = "rp-info" style = "display: flex; justify-content: space-evenly;">Reward/Penalize: 
                        ...
                        and the target's cash will increase by that amount, your own decresing by the same. Negetive values (moving
                        it left) penalize the target and will cause the target's cash to decrease by that amount and your's by 60% of it.
