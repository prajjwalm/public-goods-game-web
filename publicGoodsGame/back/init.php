...
//	 To diasable direct url access
	...
	if ($cxn->query($query) === true) {
		...
		`host` VARCHAR(255) NOT NULL , `rnd` SMALLINT NOT NULL DEFAULT 0, `max_rnd` SMALLINT NOT NULL DEFAULT 20,
        `last_balance` DECIMAL(21,3) NOT NULL DEFAULT 0, `rp` BLOB NULL DEFAULT NULL,
